...
def register_coco_dataset(root, name):
    register_coco_panoptic_annos_sem_seg(
        name,
        get_metadata(),
        os.path.join(root, f'{name}'),
        os.path.join(root, f'panoptic_{name}'),
        os.path.join(root, f'annotations/panoptic_{name}.json'),
        os.path.join(root, f'panoptic_semseg_{name}'),
        os.path.join(root, f'annotations/instances_{name}.json'),
    )